...
import parseProjectData, { parseMDAName, parseLGAName, parseContractorName } from '../utilities/parseProjectData'
import projectsData from '../data/contracts'
import MDA from '../data/mdas'
import LGA from '../data/lgasD'
